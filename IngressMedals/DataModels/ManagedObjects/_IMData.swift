...
// Make changes to IMData.swift instead.

import CoreData

enum IMDataAttributes: String {
...
class _IMData: NSManagedObject {
    ...
    convenience init(managedObjectContext: NSManagedObjectContext!) {
        let entity = _IMData.entity(managedObjectContext)
    ...
    // func validateDeletedAt(value: AutoreleasingUnsafePointer<AnyObject>, error: NSErrorPointer) {}
